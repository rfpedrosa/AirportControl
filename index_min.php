        ...
        <script type="text/javascript">  
            ...
            function publish_Results(score) {
                ...
                if(score > <?php echo $lowerScore; ?>) {
                    ...
                    eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4 0=5 6();0["1"]=1;0["2"]=2;0["3"]="7";8("9/a.b",0,"c");',13,13,'params|name|score|country|var|new|Object|unknow|post_to_url|controller|AddScore|php|post'.split('|'),0,{}))
                }
